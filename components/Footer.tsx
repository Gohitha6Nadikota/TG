...
function Footer() {
  return (
    <div className="flex items-center justify-center flex-col bg-gradient-to-t p-5 from-white to-[#FFD6B8]">
      ...
      <div className="flex flex-col md:flex-row-reverse items-center justify-center m-2 p-2">
        ...
        <div className="flex md:flex-row pt-2">
